...
sudo apt-get update && sudo apt-get install -y build-essential python-dev libssl-dev libffi-dev libzmq3-dev unzip supervisor curl python-libvirt nodejs xorriso python-setuptools
